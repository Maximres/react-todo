...
export const Details = () : JSX.Element | null => {
    ...
    const closeDetails = () => {
        ctx.dispatch({type: ActionTypes.TOGGLE_SIDEBAR, payload: {isSidebarVisible: false}})
    }
        ...
        (<aside className="d-flex flex-column align-items-stretch flex-shrink-0 bg-white overflow-auto"
            ...
            <div className="m-3">
                <div className="list-group ">
                    ...
                    <label
                        className="list-group-item group-item-height d-flex justify-content-between align-items-center">
                            <span className="me-3">
                                <File onClick={() => {
                                }}/>
                            </span>
                        <span className="form-control me-1"  onFocus={() => ({})}>Add file</span>
                    </label>
                </div>
            </div>
